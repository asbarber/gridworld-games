...
public class World<T>
{
    ...
    /** My Added Methods for additional GUI Control */
    public void run(){
        if (frame instanceof WorldFrame)
        {
            WorldFrame aGrid = (WorldFrame) frame;
            aGrid.run();
        }
    }
    public void stop(){
    ...
    public static void setWindowCount(int n){
        WorldFrame.setWindowCount(n);
    }
    public void setGridLineColor(Color c){
        if (frame instanceof WorldFrame)
        {
            WorldFrame aGrid = (WorldFrame) frame;
            aGrid.setGridLineColor(c);
        }
    }
    public void setNoGridLines(){
        if (frame instanceof WorldFrame)
        {
            WorldFrame aGrid = (WorldFrame) frame;
            aGrid.setNoGridLines();
            frame.repaint();
        }
    }    
}
